...
<head>
    ...
    <title>ТОО Аманта - Юридические услуги</title>
...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">ТОО Аманта</a>
...
<main role="main" class="container mt-4">
    <div class="jumbotron">
        <h1 class="display-4">Добро пожаловать в ТОО Аманта!</h1>
        ...
        <a class="btn btn-primary btn-lg" href="{{route('contracts.index')}}" role="button">Компании</a>
    </div>
...
<footer class="bg-dark text-white text-center py-3">
    <p>&copy; {{ date('Y') }} ТОО Аманта. Все права защищены.</p>
    <p>
